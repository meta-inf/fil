...
import logging, sys, os, hashlib, argparse
logging.basicConfig(
...
def get_parser():
    ...
    parser.add_argument('--seed_s', '-ss', type=int, default=25)
    parser.add_argument('--seed_e', '-se', type=int, default=30)
